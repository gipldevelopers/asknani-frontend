...
export default function Navbar() {
  const {
    ...
    isCityDropdownOpen, toggleCityDropdown, closeCityDropdown,
    isMobileSearchOpen, toggleMobileSearch, closeMobileSearch,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
                      ...
                      filteredCities.map((city) => (
                        <button
                          ...
                          className={`w-full text-left px-4 py-2 hover:bg-gray-50 ${
                            selectedCity === city ? "bg-indigo-50 text-primary-hover" : ""
                          }`}
                        >
                          {city}
                        </button>
          ...
          <div className="flex items-center space-x-3">
            ...
            {isLoggedIn && (
              <div className="relative">
                <Link href="/chats" className="p-2 text-gray-500 hover:text-indigo-600 relative">
            ...
            <div className="hidden md:flex items-center space-x-4">
              {isLoggedIn ? (
                <div className="relative" ref={profileDropdownRef}>
                  ...
                  {isProfileOpen && (
                    <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-2 z-[111111] border border-gray-200">
                      ...
                      <Link href="/profile/my-bookings" className="block px-4 py-2 text-gray-700 hover:bg-gray-50">
                        My Bookings
                      </Link>
                ...
                <>
                  ...
                  <Link href="/signup" className="px-5 py-2 bg-primary text-white font-medium rounded-full hover:bg-primary-hover shadow-md">
                    Get Started
                  </Link>
                </>
              )}
            ...
            {/* Hamburger */}
            <button onClick={toggleMobileMenu} className="md:hidden p-2 text-gray-500 hover:text-indigo-600">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-gray-200 space-y-2">
            {!isLoggedIn ? (
              <>
                <Link href="/login" className="block text-center px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">
                  Sign In
                </Link>
                <Link href="/signup" className="block text-center px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary-hover">
                  Get Started
                </Link>
              </>
            ) : (
              <>
                ...
                <Link href="/profile/my-bookings" className="block px-4 py-2 text-gray-700 hover:bg-gray-50 rounded-lg">
                  My Bookings
                </Link>
