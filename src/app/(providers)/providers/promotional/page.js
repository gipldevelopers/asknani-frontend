      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Promote your daycare center to thousands of parents searching for
            quality childcare in India
          </p>
        </div>
        ...
        <div className="bg-blue-50 rounded-2xl p-8 mb-12">
          <h2 className="text-2xl font-bold text-center mb-8">
            Success Stories from Daycare Providers
          </h2>
            ...
            {[
              {
                ...
                desc: "Reach parents actively searching for daycare solutions",
              },
              {
                icon: <Shield className="w-10 h-10" />,
                title: "Verified Leads",
                desc: "All inquiries are from genuine parents with real needs",
              },
              {
                icon: <Award className="w-10 h-10" />,
                title: "Premium Positioning",
                desc: "Stand out from competitors with prominent ad placements",
              },
              {
                icon: <BarChart3 className="w-10 h-10" />,
                title: "Performance Analytics",
                desc: "Track clicks, views, and conversions in real-time",
              },
            ].map((benefit, index) => (
              <div
                key={index}
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-center text-white">
          <h2 className="text-3xl font-bold mb-4">
            Ready to Grow Your Daycare Business?
          </h2>
          <p className="text-xl mb-6 max-w-3xl mx-auto">
            Join thousands of successful daycare providers who are already
            reaching more parents every day
          </p>
